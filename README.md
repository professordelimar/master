...
identify the exact file and version used;

verify the numerical implementation;

record the computational environment;

cite the original mathematical or geophysical source when applicable;

cite the repository and any associated publication when appropriate.
...
This repository also reflects research developed with the collaboration of Rodrigo Bijani, who collaborated with Nelson Ribeiro-Filho during the development of the master's research and associated computational work.

Rodrigo Bijani's academic and computational profiles are available at:

GitHub: https://github.com/rodrigobijani

Lattes Curriculum: http://lattes.cnpq.br/2331435604103641

File-specific authorship, contributions, and collaboration notices should always be preserved when present in individual source files, notebooks, or associated research material.
